...
@Component({
  selector: 'app-badge-hour-data',
  templateUrl: './badge-hour-data.component.html',
  styleUrls: ['./badge-hour-data.component.css']
})
export class BadgeHourDataComponent implements OnInit {  
  ...
  ngOnInit() {
    ...
    this.vpnService.getVpnDataByWeek().subscribe (data=>{   
     ...
     // this.drawBars();
        ...
        console.log('userhourdata' , vpnObj);
