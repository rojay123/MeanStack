...
@Component({
  selector: 'app-vpn-day-data',
  templateUrl: './vpn-day-data.component.html',
  styleUrls: ['./vpn-day-data.component.css']
})
export class VpnDayDataComponent implements OnInit {
