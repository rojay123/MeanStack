...
@Component({
  selector: 'app-vpn-hours-data',
  templateUrl: './vpn-hours-data.component.html',
  styleUrls: ['./vpn-hours-data.component.css']
})
export class VpnHoursDataComponent implements OnInit {  
